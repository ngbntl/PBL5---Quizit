<template>
    <div class="">
        ...
        <h1 class="mt-24 mx-24 text-4xl text-blue-500 font-bold">Chào mừng bạn đến với Quizit</h1>
            ...
            <div class="p-6 bg-white rounded shadow-md w-1/2">
                ...
                <div class="mb-4">
                    <input type="email" v-model="email"
                        :class="`w-full px-3 py-2 border rounded-md focus:outline-none ${emailError ? 'border-red-500' : 'border-gray-300 focus:border-blue-500'}`"
                        placeholder="Email">
                ...
                <p class="text-right text-blue-500 hover:text-blue-700 cursor-pointer">Quên mật khẩu?</p>
                <button @click="validateForm"
                    class="w-full py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-500 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">Đăng
                    nhập</button>
                <p class="mt-4 text-center">Bạn chưa có tài khoản? <a href="/register"
                        class="text-blue-500 hover:text-blue-700">Đăng ký</a></p>
            </div>
